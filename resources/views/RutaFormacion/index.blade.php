                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Ruta Formacion</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('guardarFormacion') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ruta_Nombre">Nombre</label>
                                                <input class="form-control" type="text" name="Ruta_Nombre" id="Ruta_Nombre" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ruta_Nombre">Programa</label>
                                                <select name="Programa_id" id="Programa_id" class="form-select">
                                                    <option hidden></option>
                                                    @foreach ($qu as $in)
                                                    <option value="{{ $in->id }}">{{ $in->Progra_Nombre }}</option>
                                                    @endforeach
                                                </select>
