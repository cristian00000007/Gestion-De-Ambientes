...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
            { data: 'id'},
            { data: 'Tipo_Progra_Nombre'},
            { data: 'Tipo_Progra_Estado'},
            { data: 'Acciones'},
          ],
      columnDefs: [
        {
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Tipo Programa</h6>');
  }
