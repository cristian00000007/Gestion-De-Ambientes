                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Tipo Programa</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('InsertarTipoPro') }}" novalidate>
                                        @csrf
                                        <div class="row g-1">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Tipo_Progra_Nombre">Tipo de Programa</label>
                                                <input type="text" class="form-control" name="Tipo_Progra_Nombre" id="Tipo_Progra_Nombre" required>
                                            ...
                                            {{-- <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <select name="TipoPrograma_id" class="form-control" id="TipoPrograma_id" required>
