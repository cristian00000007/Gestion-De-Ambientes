                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Resultados</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('InsertR') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-12 position-relative">
                                                <label for="competencias_id">Competencias</label>
                                                <select name="competencias_id" class="form-select" id="competencias_id" required>
                                                    @foreach ($infoPrograma as $programas)
                                                    <option hidden></option>
                                                    <option value="{{ $programas->id }}" style="text-align: center">{{ $programas->Compet_Nombre }}</option>

                                                    @endforeach

                                                </select>
                                                <div class="invalid-tooltip">La Competencia es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-12 position-relative">
                                                <label for="Result_Nombre">Nombre de Resultado</label>
                                                <input type="text" name="Result_Nombre" id="Result_Nombre" class="form-control" required>
                                                <div class="invalid-tooltip">El Resultado es Obligatorio.</div>
                                            </div>
