...
<script>
    function borrar(id){
                swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        var url2='{{ route('eliminarResultadoCompetencia','id') }}';
...
$(function () {
  ...
  if (dt_basic_table.length) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var id = full['id'];
            var url = '{{ route('actualizarResultaodCompetencia','id') }}';
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Resultados</h6>');
  }
