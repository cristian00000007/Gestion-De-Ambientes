                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Aprendiz</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('gAprendiz')}}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <input value="Aprendiz" name="rol" id="rol" type="hidden">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="FichaId">Ficha</label>
                                                <select name="FichaId" id="FichaId" class="form-select" required>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Aprend_Nombres">Nombre de Aprendiz</label>
                                                <input type="text" name="Aprend_Nombres" id="Aprend_Nombres" class="form-control" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Aprend_Apellidos">Apellido de Aprendiz</label>
                                                <input type="text" name="Aprend_Apellidos" id="Aprend_Apellidos" class="form-control" required>
                                                <div class="invalid-tooltip">El Apellido es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Aprend_Documento">Numero de Documento</label>
                                                <input type="number" name="Aprend_Documento" id="Aprend_Documento"  class="form-control" required>
                                                <div class="invalid-tooltip">El Numero es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Aprend_Celular">Numero de Celular</label>
                                                <input type="number" name="Aprend_Celular" id="Aprend_Celular"  class="form-control" required>
                                                <div class="invalid-tooltip">El Numero es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Aprend_Email">Email</label>
                                                <input type="email" name="Aprend_Email" id="Aprend_Email" class="form-control" required>
                                                <div class="invalid-tooltip">El Email es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Aprend_Foto">Correo</label>
                                                <input type="file" name="Aprend_Foto" id="Aprend_Foto" class="form-control" accept=".jpg, .png, .gif" required>
                                                <div class="invalid-tooltip">La Foto es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
