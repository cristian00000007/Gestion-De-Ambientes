...
<script>
    function borrar(id){
                swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        var url2='{{ route('eliminarAprendiz','id') }}';
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
                { data: 'id'},
                { data: 'Aprend_Nombres'},
                { data: 'Aprend_Apellidos'},
                { data: 'Aprend_Documento'},
                { data: 'Aprend_Celular'},
                { data: 'Aprend_Email'},
                { data: 'Aprend_Estado'},
                { data: 'correoA'}
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var id = full['id'];
            var url = '{{ route('actualizarAprendiz','id') }}';
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Aprendices</h6>');
  }
