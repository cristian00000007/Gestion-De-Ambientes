...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
            { data: 'id' },
            { data: 'CategAmbien_Nombres' },
            { data: 'CategAmbien_Estado' },
            { data: 'Acciones' },
          ],
      columnDefs: [
        {
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Categoria Ambientes</h6>');
  }
