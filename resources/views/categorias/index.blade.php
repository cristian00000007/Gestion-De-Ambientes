                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('guardadCategoria') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="CategAmbien_Nombres">Nombre</label>
                                                <input class="form-control" type="text" name="CategAmbien_Nombres" id="CategAmbien_Nombres" required>
