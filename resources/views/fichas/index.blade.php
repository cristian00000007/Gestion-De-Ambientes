                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Ficha</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('guardarF') }}" method="post" novalidate>
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <input type="number" name="Ficha_Numero" id="Ficha_Numero" class="form-control" required>
                                                <div class="invalid-tooltip">El Numero es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ficha_CantidadApren">Cantidad de Aprendices</label>
                                                <input type="number" name="Ficha_CantidadApren" id="Ficha_CantidadApren" class="form-control" required>
                                                <div class="invalid-tooltip">La Cantiad es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ficha_Jornada">jornada</label>
                                                <input type="text" name="Ficha_Jornada" id="Ficha_Jornada" class="form-control" required>
                                                <div class="invalid-tooltip">La Jornada es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ficha_FechaInicio">Ficha de Inicio</label>
                                                <input type="date" name="Ficha_FechaInicio" id="Ficha_FechaInicio" placeholder="Dia de inicio de la ficha" class="form-control" required>
                                                <div class="invalid-tooltip">El Inicio es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ficha_FechaFin">Fecha de Fin</label>
                                                <input type="date" name="Ficha_FechaFin" id="Ficha_FechaFin" placeholder="Dia de final de la ficha" class="form-control" required>
