                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('guardarinstructor') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <input type="hidden" name="rol" id="rol" value="Instructor">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Nombres">Nombre de Instructor</label>
                                                <input class="form-control" type="text" name="Instruct_Nombres" id="Instruct_Nombres" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Apellidos">Apellido de Instructor</label>
                                                <input class="form-control" type="text" name="Instruct_Apellidos" id="Instruct_Apellidos" required>
                                                <div class="invalid-tooltip">El Apellido es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_EmailInstitucional">Correo Institucional</label>
                                                <input class="form-control" type="email" name="Instruct_EmailInstitucional" id="Instruct_EmailInstitucional" required>
                                                <div class="invalid-tooltip">El Correo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruc_Cedula">cedula</label>
                                                <input class="form-control" type="number" name="Instruc_Cedula" id="Instruc_Cedula" required>
                                                <div class="invalid-tooltip">El Correo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_EmailAlternativo">Correo Alternativo</label>
                                                <input class="form-control" type="email" name="Instruct_EmailAlternativo" id="Instruct_EmailAlternativo" required>
                                                <div class="invalid-tooltip">El Correo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Celular">Numero de Celular</label>
                                                <input class="form-control" type="number" name="Instruct_Celular" id="Instruct_Celular" required>
                                                <div class="invalid-tooltip">El Numero es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="horasI">Horas de Trabajo</label>
                                                <input class="form-control" type="number" name="horasI" id="horasI" required>
                                                <div class="invalid-tooltip">Las Horas es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="AreaTematicaId">Area Tematica</label>
                                                <select name="AreaTematicaId" id="AreaTematicaId" class="form-select" required>
                                                    @foreach ($verA as $info )
                                                    <option hidden></option>
                                                    <option value="{{ $info->id }}">{{ $info->Area_Tem_Nombre }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-tooltip">La Tematica es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="TipoVinculacionId">Tipo de Vinculacion</label>
                                                <select name="TipoVinculacionId" id="TipoVinculacionId" class="form-select" required>
                                                    @foreach ($verP as $info )
                                                    <option hidden></option>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Foto">Foto</label>
                                                <input class="form-control" type="file" name="Instruct_Foto" id="Instruct_Foto" accept=".jpg, .png, .gif" required>
                                                <div class="invalid-tooltip">La Foto es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
