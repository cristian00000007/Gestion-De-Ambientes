...
<script>
    function borrar(id){
                swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        var url2='{{ route('eliminarInstructor','id') }}';
...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
            { data: 'id' },
            { data: 'Instruct_Nombres'},
            { data: 'Instruct_Celular'},
            { data: 'Instruct_Apellidos'},
            { data: 'Instruct_EmailInstitucional'},
            { data: 'Instruct_EmailAlternativo'},
            { data: 'Instruct_Estado'},
            { data: 'AreaTematicaId'},
            { data: 'TipoVinculacionId'},
            { data: 'Acciones'},
          ],
      columnDefs: [
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var id = full['id'];
            var url = '{{ route('actualizarInstructor','id') }}';
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado Instructor</h6>');
  }
