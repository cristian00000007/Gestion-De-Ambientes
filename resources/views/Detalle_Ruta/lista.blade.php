...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
            { data: 'id' },
            { data: 'Detalle_Ruta_Horas'},
            { data: 'Detalle_Ruta_TemaPrincipal'},
            { data: 'Detalle_Ruta_Trimestre'},
            { data: 'Detalle_Ruta_Estado'},
            { data: 'RutaFormacionId'},
            { data: 'Acciones' },
          ],
      columnDefs: [
        {
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Detalle Ruta</h6>');
  }
