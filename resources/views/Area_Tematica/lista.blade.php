...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
                { data: 'id'},
                { data: 'Area_Tem_Nombre'},
                { data: 'Area_Tem_Estado'},
                { data: 'Actions'}
            ],
      columnDefs: [
        {
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Fichas</h6>');
  }
