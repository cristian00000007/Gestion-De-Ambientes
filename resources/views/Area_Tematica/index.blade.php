                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Area Tematica</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('GuardarAreaT') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Area_Tem_Nombre">Nombre de Competencia</label>
                                                <input class="form-control" type="text" name="Area_Tem_Nombre" id="Area_Tem_Nombre" required>
