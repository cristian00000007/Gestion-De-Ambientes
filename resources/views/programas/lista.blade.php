...
<script>
    function borrar(id){
                swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        var url2='{{ route('eliminarPrograma','id') }}';
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
            ...
            { data: 'Progra_Codigo' },
            { data: 'Progra_Version' },
            { data: 'Progra_TipoDuracion' },
            { data: 'Progra_Duracion' },
            { data: 'Progra_FechaRegistro' },
            { data: 'Progra_Estado' },
            { data: 'TipoPrograma_id' },
            { data: 'Acciones' },
          ],
      columnDefs: [
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var id = full['id'];
            var url = '{{ route('actualizarPrograma','id') }}';
