                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Programa</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('insertarPrograma') }}" novalidate>
                                        @csrf
                                        <div class="row g-1">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Progra_Nombre">Nombre de Programa</label>
                                                <input type="text" class="form-control" name="Progra_Nombre" id="Progra_Nombre" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Progra_Codigo">Codigo de Programa</label>
                                                <input type="text" class="form-control" name="Progra_Codigo" id="Progra_Codigo" required>
                                                <div class="invalid-tooltip">El Codigo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Progra_Version">Version</label>
                                                <input type="text" class="form-control" name="Progra_Version" id="Progra_Version" required>
                                                <div class="invalid-tooltip">La Version es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Progra_TipoDuracion">Tipo de Duracion</label>
                                                <input type="text" class="form-control" name="Progra_TipoDuracion" id="Progra_TipoDuracion" required>
                                                <div class="invalid-tooltip">El Tipo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Progra_Duracion">Duracion</label>
                                                <input type="number" class="form-control" name="Progra_Duracion" id="Progra_Duracion" required>
                                                <div class="invalid-tooltip">La Duracion es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Progra_FechaRegistro">Fecha de registro</label>
                                                <input class="form-control" type="date" name="Progra_FechaRegistro" id="Progra_FechaRegistro" required>
                                                <div class="invalid-tooltip">La Fecha es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="TipoPrograma_id">Tipo de Programa</label>

                                                <select name="TipoPrograma_id" class="form-select" id="TipoPrograma_id" required>
                                                    @foreach ($vertipo as $ver)
                                                    <option value="{{ $ver->id }}">{{ $ver->Tipo_Progra_Nombre}}</option>
                                                    @endforeach
                                                </select>
