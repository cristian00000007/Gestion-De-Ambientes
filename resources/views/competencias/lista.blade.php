...
<script>
    function borrar(id){
                swal({
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        var url2='{{ route('eliminarcompetencia','id') }}';
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columns: [
            ...
            { data: 'Compet_Nombre'},
            { data: 'Compet_Horas'},
            { data: 'Compet_ConociProceso'},
            { data: 'Compet_ConociSaber'},
            { data: 'Compet_Criterios'},
            { data: 'Compet_Estado'},
            { data: 'programa_id'},
            { data: 'Acciones'},
          ],
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var id = full['id'];
            var url = '{{ route('actualizarCompetencia','id') }}';
    ...
    $('div.head-label').html('<h6 class="mb-0">Listado de Competencias</h6>');
  }
