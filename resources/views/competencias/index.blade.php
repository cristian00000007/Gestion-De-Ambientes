                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Competencia</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('insertCompetencia') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Nombre">Nombre de Competencia</label>
                                                <input class="form-control" type="text" name="Compet_Nombre" id="Compet_Nombre" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Horas">Horas de Competencia</label>
                                                <input class="form-control" type="number" name="Compet_Horas" id="Compet_Horas" required>
                                                <div class="invalid-tooltip">La Horas es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_ConociProceso">Proceso de Competencia</label>
                                                {{-- <textarea class="" name="" id=""></textarea> --}}
                                                <input class="form-control" type="text" name="Compet_ConociProceso" id="Compet_ConociProceso" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_ConociSaber">Saber de Competencia</label>
                                                <input class="form-control" type="text" name="Compet_ConociSaber" id="Compet_ConociSaber" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Criterios">Criterios de Competencia</label>
                                                <input class="form-control" type="text" name="Compet_Criterios" id="Compet_Criterios" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label>Programa Perteneciente</label>
                                                <select name="programa_id" class="form-select" id="programa_id" required>
                                                    @foreach ($infoPrograma as $programas)
                                                    <option hidden></option>
                                                    <option value="{{ $programas->id }}" style="text-align: center">{{ $programas->Progra_Nombre }}</option>
