                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDTV') }}" novalidate>
                                        @csrf
                                        <div class="row g-1">
                                            <div>
                                                <input hidden name="id" value="{{ $updateI->id }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Tipo_Vin_Nombre">Tipo de Vinculacion</label>
                                                <input type="text" class="form-control" name="Tipo_Vin_Nombre" id="Tipo_Vin_Nombre" value="{{ $updateI->Tipo_Vin_Nombre }}" required>
                                                <div class="invalid-tooltip">El Tipo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Tipo_Vin_CantidadHoras">Horas</label>
                                                <input type="number" class="form-control" name="Tipo_Vin_CantidadHoras" id="Tipo_Vin_CantidadHoras" value="{{ $updateI->Tipo_Vin_CantidadHoras }}" required>
