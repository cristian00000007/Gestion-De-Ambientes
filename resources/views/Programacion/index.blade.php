                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('GPcion') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Program_Fecha">Fecha</label>
                                                <input class="form-control" type="date" name="Program_Fecha" id="Program_Fecha" required>
                                                <div class="invalid-tooltip">La fecha es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Program_Trimestre">Trimestre</label>
                                                <select class="form-select" type="number" name="Program_Trimestre" id="Program_Trimestre" required>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <select class="form-control" name="Program_Franja" id="Program_Franja" required>
