                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Programacion</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDPcion') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                                <input hidden name="id" value="{{ $updatePro->id }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Program_Fecha">Fecha</label>
                                                <input class="form-control" type="date" name="Program_Fecha" id="Program_Fecha" value="{{ $updatePro->Program_Fecha}}" required>
                                                <div class="invalid-tooltip">La Fecha es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Program_Trimestre">Trimestre</label>
                                                <input class="form-control" type="number" name="Program_Trimestre" id="Program_Trimestre" value="{{ $updatePro->Program_Trimestre}}" required>
                                                <div class="invalid-tooltip">El Trimestre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Program_Franja">Franja</label>
                                                <input class="form-control" type="text" name="Program_Franja" id="Program_Franja" value="{{ $updatePro->Program_Franja}}" required>
                                                <div class="invalid-tooltip">La Franja es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="ambientesIdAmbientes">Ambiente</label>
                                                <select class="form-select" name="ambientesIdAmbientes" id="ambientesIdAmbientes" required>
                                                    @foreach ($verAm as $info)
                                                    <option hidden></option>
                                                    <option value="{{ $info->id }}">{{ $info->Ambien_Nombres}}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-tooltip">El Ambiente es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="FichaId">Ficha</label>
                                                <select class="form-select" name="FichaId" id="FichaId" required>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <select class="form-select" name="InstructorId" id="InstructorId" required>
                                                    @foreach ($verI as $info)
                                                    <option hidden></option>
                                                    <option value="{{ $info->id }}">{{ $info->Instruct_Nombres}}</option>

                                                    @endforeach
                                                </select>
                                                <div class="invalid-tooltip">Las Nombre es Obligatorio.</div>
                                            </div>
                                            <div>
                                                <br>
                                                <button class="btn btn-primary" type="submit" value="Registrar">ACTUALIZAR</button>
                                            </div>
                                        </div>
