                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Registro de Ambiente</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('GuardarAmbiente') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Nombres">Nombre de Ambiente</label>
                                                <input class="form-control" type="text" name="Ambien_Nombres" id="Ambien_Nombres" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Capacidad">Capacidad de Ambiente</label>
                                                <input class="form-control" type="number" name="Ambien_Capacidad" id="Ambien_Capacidad" required>
                                                <div class="invalid-tooltip">La Capacidad es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Foto">Foto de Ambiente</label>
                                                <input class="form-control" type="file" name="Ambien_Foto" id="Ambien_Foto" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Observacion">Observacion de Ambiente</label>
                                                <input class="form-control" type="text" name="Ambien_Observacion" id="Ambien_Observacion" required>
                                                <div class="invalid-tooltip">La Observacion es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="CategoriaAmbienteId">Categoria</label>
                                                <select name="CategoriaAmbienteId" id="CategoriaAmbienteId" class="form-select" required>
                                                    @foreach ($verCagAmbiente as $info)
                                                    <option hidden></option>
                                                    <option value="{{ $info->id }}">{{ $info->CategAmbien_Nombres }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-tooltip">La Categoria es Obligatoria.</div>
                                            </div>
                                            <div>
                                                <br>
