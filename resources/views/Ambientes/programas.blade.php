                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h1>Ambientes Programados</h1>
                                    @foreach ($ge as $info)
                                    <h4>Nombre: {{  $info->Ambien_Nombres}}</h4>
                                    <h4>Cantidad De Personas: {{ $info->Ambien_Capacidad }}</h4>
                                    <h4>Foto: <img id="foto"  src="{{ asset('storage/'.$info->Ambien_Foto) }}"  height="55" width="55"></h4>
                                    <h4>Observacion: {{ $info->Ambien_Observacion }} </h4>
                                    <h4>Categoria: {{ $info->CategoriaAmbienteId }} </h4>
                                    @endforeach
                                </div>
                                <div class="card-body">
                                </div>
